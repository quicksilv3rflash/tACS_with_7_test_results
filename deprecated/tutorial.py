#This is the final version of the tutorial.
...
pygame.display.set_caption("tACS tutorial program")
...
#We start with maze number thirty.
mazenumber = 30
#some text to help the user align the window / remind them to take tutorial
introtext = font.render("Welcome to the tACS experiment tutorial."
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 25))
introtext = font.render("In the experiment you will be shown the path"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 60))
introtext = font.render("through the maze. You will then follow this path"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 95))
introtext = font.render("yourself. The end of the maze is in the top-right"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 130))
introtext = font.render("corner. You will start in the bottom-left corner."
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 165))
introtext = font.render("Pressing the arrow key moves you one cell. You"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 200))
introtext = font.render("will need to press the arrow keys repeatedly to"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575,235))
introtext = font.render("move through multiple cells. Follow the path"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 270))
introtext = font.render("through these two mazes to complete the tutorial."
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 305))
introtext = font.render("Experiment administration instructions can be"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 340))
introtext = font.render("found in the file experiment_instructions.pdf"
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 375))
introtext = font.render("which was supplied with this program."
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 410))
introtext = font.render(""
                        , 0,(0,255,255))
displaysurface.blit(introtext, (575, 445))
introtext = font.render("Press any key to continue."
                        , 0,(0,255,255))
...
#----==== USER INPUT / EVENT HANDLING LOOP ====----
    ...
    mazenumber += 1
#later this will only be triggered after completion of maze31!
#of course, this is implemented by checking for mazenumber == 32...
    if(mazenumber == 32):

        #set output to 0mA
        setoutputcurrent(127)
        font = pygame.font.Font(None, 70)
        exittext = font.render("TO EXIT TUTORIAL:"
                               , 0,(0,255,255))
        displaysurface.blit(exittext, (580, 230))
        exittext = font.render("PRESS ANY KEY"
                               , 0,(0,255,255))
